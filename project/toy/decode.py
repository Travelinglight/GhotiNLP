...
optparser.add_option("-i", "--input", dest="input", default="data/train.cn", help="File containing sentences to translate (default=data/input)")
optparser.add_option("-t", "--translation-model", dest="tm", default="phrase-table/phrase_table.out", help="File containing translation model (default=data/tm)")
optparser.add_option("-l", "--language-model", dest="lm", default="data/en.tiny.3g.arpa", help="File containing ARPA-format language model (default=data/lm)")
