...
optparser.add_option("-l", "--language-model", dest="lm", default="data/lm/en.gigaword.3g.filtered.dev_test.arpa", help="File containing ARPA-format language model (default=data/lm)")
