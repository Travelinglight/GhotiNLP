...
optparser.add_option("-s", "--stack-size", dest="s", default=100, type="int", help="Maximum stack size (default=10)")
...
print >> sys.stderr, "TEST BLEU SCORE: %f:" % scorereranker.score(results, opts.reference)
