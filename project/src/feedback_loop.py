...
nbest_list = list(decode.get_candidates(opts.eval, tm, lm, weights, nbest=1, stack_size=opts.stack_size, verbose=opts.verbose, simpmode=opts.simplify, separate_unknown_words=opts.reseg_unknown))
